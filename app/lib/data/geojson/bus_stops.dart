...
// 9 Bus stops
// TODO: refactor to just use triggers
const List<Map<String, dynamic>> kBusStopsPointsGeoJSON = [
  {
    "type": "Feature",
    "properties": {},
    "geometry": {
...
const List<Map<String, dynamic>> kBusStopsTriggersGeoJSON = [
  {
    "type": "Feature",
...
final kBusStopsTriggerAreas = kBusStopsTriggersGeoJSON.mapIndexed((i, trigger) {
  final shape = trigger['geometry']['coordinates'][0] as List<List<double>>;
  final name = trigger['properties']['name'] as String;
  final num = trigger['properties']['num'] as int;
...
final kUNMSMBusStopsMarkers =
    Future.wait(kBusStopsPointsGeoJSON.mapIndexed((i, busstop) async {
